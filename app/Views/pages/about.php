        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="<?= base_url('public/assets/images/person_4.jpg')?>" alt="Image" class="img-fluid rounded mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="<?= base_url('public/assets/images/person_5.jpg')?>" alt="Image" class="img-fluid rounded mb-4">
