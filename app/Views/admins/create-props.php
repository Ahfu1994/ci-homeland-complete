        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
                    ...
                    <form method="POST" action="<?= url_to('props.store')?>" enctype="multipart/form-data">
                        <!-- Email input -->
                        ...
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="num_beds" id="form2Example1" class="form-control" placeholder="beds" />
                        </div>
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="num_baths" id="form2Example1" class="form-control" placeholder="baths" />
                        </div>
                        <div class="form-outline mb-4 mt-4">
                        ...
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="price_sq_ft" id="form2Example1" class="form-control" placeholder="Price Per SQ FT" />
                        </div> 
                        <div class="form-outline mb-4 mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="More Info" name="description" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                        <!-- <div class="form-outline mb-4 mt-4">
